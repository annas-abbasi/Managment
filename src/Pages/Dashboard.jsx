                ...
                <div className="grid grid-cols-8 sm:grid-cols-10">
                    ...
                    <div className="min-h-screen col-span-2 hidden sm:block px-4 bg-gray-50">
                        <ul className='flex items-start flex-col gap-2'>
                            ...
                            <Link to="/dashboard/ProjectReview" className={`w-full mt-5 cursor-pointer border-l-2 px-2 py-2 font-semibold transition ${activeLink === '/dashboard/ProjectReview' || activeLink === '/dashboard/ProjectReview/SubProjectReview' ? 'border-l-blue-700 text-blue-700' : 'border-transparent hover:border-l-blue-700 hover:text-blue-700'}`}>Project Review</Link>
