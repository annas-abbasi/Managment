      ...
      {activeLink === '/dashboard/Profile' && (
        <div className='grid grid-cols-3'>
          {tasks.map((e, index) => {
            ...
            return (
              <Link to='/dashboard/Profile/ViewProfile' className="mx-6 mb-10 max-w-sm cursor-pointer hover:shadow-md transition-all" key={e._id}>
        ...
        // : (// <ViewProfile navigate='/dashboard/Profile' />
        //   <p>he</p>)
      }
