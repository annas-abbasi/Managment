    ...
    return (
        <div className='flex items-center justify-center flex-col space-y-10 mb-10 mt-4'>
            ...
            <div className='self-start relative'>
                ...
                <img src={Img1} alt="user" className='w-48 h-48' />
                <div className='absolute bottom-10 right-0 bg-zinc-50 border py-[2px] px-4 text-gray-600 rounded-md cursor-pointer hover:border-gray-600 hover:text-black transition-all'>
                    edit
                </div>
